...
public class TC60_Login_And_Verify_HamburgerManuPage_Workflow 
{
	
TestUtils utils = new TestUtils();
	
	//GET STARTED
    public static TC60_Login_And_Verify_HamburgerManuPage_Workflow getStartedPage(Consumer<GetStartedPage> c){
    	GetStartedPage p = new GetStartedPage();
        c.accept(p);
        return new TC60_Login_And_Verify_HamburgerManuPage_Workflow();
    }
    
    //GRANT PERMISSIONS
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow grantPermissionsPage(Consumer<GrantPermissionsPage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow deviceLocationPage(Consumer<DeviceLocationPage> c){
   ...
   //Access resource on device media-contacts
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow accessResourcesOnDevicePage(Consumer<AccessResourcesOnDevicePage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow selectYourDevicePage(Consumer<SelectYourDevicePage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow selectYourDevicePage2(Consumer<SelectYourDevicePage2> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow welcomeSigninPage(Consumer<SiginPage> c){
    ...
    //Get OTP from email 
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow getOTPCode(Consumer<ValidOTP> c){
  ...
  //enter OTP
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow enterOTPPage(Consumer<EnterValidOTPPage> c){
    ...
    //OTP verified
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow codeVerifiedPage(Consumer<CodeVerifiedPage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow somethingWentWrongPage(Consumer<ErrorCode_0015_1805_Something_Went_Wrong_Page> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow setupWifi(Consumer<SetUpYourWiFiManagementPage> c){
    ...
    //Home Page
    public static TC60_Login_And_Verify_HamburgerManuPage_Workflow homePage(Consumer<HomePage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow devicesPage(Consumer<DevicesPage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow deviceSignalStrengthPage(Consumer<DeviceSignalStrengthLeaderBoardPage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow speedTestHistoryPage(Consumer<SpeedTestHistoryPage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow currentlyBlockedDevicesPage(Consumer<CurrentlyBlockedDevicesPage> c){
    ...
    //Network Page
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow networkPage(Consumer<NetworkPage> c){
    ...
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow parentalControlPage(Consumer<ParentalControlPage> c){
    ...
    //Hamburger Manu Page
    public TC60_Login_And_Verify_HamburgerManuPage_Workflow hamburgerManuPage(Consumer<HamburgerMenuPage> c){
