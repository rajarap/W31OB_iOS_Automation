...
public class TC52_Login_And_Verify_HomePage_Workflow 
{
	
TestUtils utils = new TestUtils();
	
	//GET STARTED
    public static TC52_Login_And_Verify_HomePage_Workflow getStartedPage(Consumer<GetStartedPage> c){
    	GetStartedPage p = new GetStartedPage();
        c.accept(p);
        return new TC52_Login_And_Verify_HomePage_Workflow();
    }
    
    //GRANT PERMISSIONS
    public TC52_Login_And_Verify_HomePage_Workflow grantPermissionsPage(Consumer<GrantPermissionsPage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow deviceLocationPage(Consumer<DeviceLocationPage> c){
   ...
   //Access resource on device media-contacts
    public TC52_Login_And_Verify_HomePage_Workflow accessResourcesOnDevicePage(Consumer<AccessResourcesOnDevicePage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow selectYourDevicePage(Consumer<SelectYourDevicePage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow selectYourDevicePage2(Consumer<SelectYourDevicePage2> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow welcomeSigninPage(Consumer<SiginPage> c){
    ...
    //Get OTP from email 
    public TC52_Login_And_Verify_HomePage_Workflow getOTPCode(Consumer<ValidOTP> c){
  ...
  //enter OTP
    public TC52_Login_And_Verify_HomePage_Workflow enterOTPPage(Consumer<EnterValidOTPPage> c){
    ...
    //OTP verified
    public TC52_Login_And_Verify_HomePage_Workflow codeVerifiedPage(Consumer<CodeVerifiedPage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow somethingWentWrongPage(Consumer<ErrorCode_0015_1805_Something_Went_Wrong_Page> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow setupWifi(Consumer<SetUpYourWiFiManagementPage> c){
    ...
    //Home Page
    public TC52_Login_And_Verify_HomePage_Workflow homePage(Consumer<HomePage> c){
    ...
    //Main Device Page
    public TC52_Login_And_Verify_HomePage_Workflow mainDevicePage(Consumer<MainDevicePage> c){
    ...
    //Devices Page
    public TC52_Login_And_Verify_HomePage_Workflow devicesPage(Consumer<DevicesPage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow deviceSignalStrengthPage(Consumer<DeviceSignalStrengthLeaderBoardPage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow speedTestHistoryPage(Consumer<SpeedTestHistoryPage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow currentlyBlockedDevicesPage(Consumer<CurrentlyBlockedDevicesPage> c){
    ...
    //Network Page
    public TC52_Login_And_Verify_HomePage_Workflow networkPage(Consumer<NetworkPage> c){
    ...
    public TC52_Login_And_Verify_HomePage_Workflow parentalControlPage(Consumer<ParentalControlProfilesPage> c){
