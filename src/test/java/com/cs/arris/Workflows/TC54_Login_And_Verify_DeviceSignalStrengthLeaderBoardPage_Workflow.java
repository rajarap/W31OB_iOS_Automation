...
public class TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow 
{
	
TestUtils utils = new TestUtils();
	
	//GET STARTED
    public static TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow getStartedPage(Consumer<GetStartedPage> c){
    	GetStartedPage p = new GetStartedPage();
        c.accept(p);
        return new TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow();
    }
    
    //GRANT PERMISSIONS
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow grantPermissionsPage(Consumer<GrantPermissionsPage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow deviceLocationPage(Consumer<DeviceLocationPage> c){
   ...
   //Access resource on device media-contacts
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow accessResourcesOnDevicePage(Consumer<AccessResourcesOnDevicePage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow selectYourDevicePage(Consumer<SelectYourDevicePage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow selectYourDevicePage2(Consumer<SelectYourDevicePage2> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow welcomeSigninPage(Consumer<SiginPage> c){
    ...
    //Get OTP from email 
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow getOTPCode(Consumer<ValidOTP> c){
  ...
  //enter OTP
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow enterOTPPage(Consumer<EnterValidOTPPage> c){
    ...
    //OTP verified
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow codeVerifiedPage(Consumer<CodeVerifiedPage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow somethingWentWrongPage(Consumer<ErrorCode_0015_1805_Something_Went_Wrong_Page> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow setupWifi(Consumer<SetUpYourWiFiManagementPage> c){
    ...
    //Home Page
    public static TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow homePage(Consumer<HomePage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow devicesPage(Consumer<DevicesPage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow deviceSignalStrengthPage(Consumer<DeviceSignalStrengthLeaderBoardPage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow speedTestHistoryPage(Consumer<SpeedTestHistoryPage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow currentlyBlockedDevicesPage(Consumer<CurrentlyBlockedDevicesPage> c){
    ...
    //Network Page
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow networkPage(Consumer<NetworkPage> c){
    ...
    public TC54_Login_And_Verify_DeviceSignalStrengthLeaderBoardPage_Workflow parentalControlPage(Consumer<ParentalControlProfilesPage> c){
