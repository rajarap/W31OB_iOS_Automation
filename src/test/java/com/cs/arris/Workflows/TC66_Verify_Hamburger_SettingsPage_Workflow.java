...
public class TC66_Verify_Hamburger_SettingsPage_Workflow {

	TestUtils utils = new TestUtils();

	// GRANT PERMISSIONS
	public TC66_Verify_Hamburger_SettingsPage_Workflow grantPermissionsPage(Consumer<GrantPermissionsPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow deviceLocationPage(Consumer<DeviceLocationPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow accessResourcesOnDevicePage(
			Consumer<AccessResourcesOnDevicePage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow selectYourDevicePage(Consumer<SelectYourDevicePage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow selectYourDevicePage2(Consumer<SelectYourDevicePage2> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow welcomeSigninPage(Consumer<SiginPage> c) {
	...
	// Get OTP from email
	public TC66_Verify_Hamburger_SettingsPage_Workflow getOTPCode(Consumer<ValidOTP> c) {
	...
	// enter OTP
	public TC66_Verify_Hamburger_SettingsPage_Workflow enterOTPPage(Consumer<EnterValidOTPPage> c) {
	...
	// OTP verified
	public TC66_Verify_Hamburger_SettingsPage_Workflow codeVerifiedPage(Consumer<CodeVerifiedPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow somethingWentWrongPage(
			Consumer<ErrorCode_0015_1805_Something_Went_Wrong_Page> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow setupWifi(Consumer<SetUpYourWiFiManagementPage> c) {
	...
	// Home Page
	public static TC66_Verify_Hamburger_SettingsPage_Workflow homePage(Consumer<HomePage> c) {
		HomePage p = new HomePage();
		c.accept(p);
		return new TC66_Verify_Hamburger_SettingsPage_Workflow();
	}

	// Devices Page - Till here
	public TC66_Verify_Hamburger_SettingsPage_Workflow devicesPage(Consumer<DevicesPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow deviceSignalStrengthPage(
			Consumer<DeviceSignalStrengthLeaderBoardPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow speedTestHistoryPage(Consumer<SpeedTestHistoryPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow currentlyBlockedDevicesPage(
			Consumer<CurrentlyBlockedDevicesPage> c) {
	...
	// Network Page
	public TC66_Verify_Hamburger_SettingsPage_Workflow networkPage(Consumer<NetworkPage> c) {
	...
	public TC66_Verify_Hamburger_SettingsPage_Workflow parentalControlPage(Consumer<ParentalControlPage> c) {
...
//Hamburger Manu Page
	public TC66_Verify_Hamburger_SettingsPage_Workflow hamburgerMenuPage(Consumer<HamburgerMenuPage> c) {
...
//Hamburger Manu Page
	public TC66_Verify_Hamburger_SettingsPage_Workflow settingsPage(Consumer<SettingsAboutHelpPage> c) {
