...
public class TC56_Login_And_Verify_MainDevicesPage_Workflow 
{
	
TestUtils utils = new TestUtils();
	
	//GET STARTED
    public static TC56_Login_And_Verify_MainDevicesPage_Workflow getStartedPage(Consumer<GetStartedPage> c){
    	GetStartedPage p = new GetStartedPage();
        c.accept(p);
        return new TC56_Login_And_Verify_MainDevicesPage_Workflow();
    }
    
    //GRANT PERMISSIONS
    public TC56_Login_And_Verify_MainDevicesPage_Workflow grantPermissionsPage(Consumer<GrantPermissionsPage> c){
    ...
    public TC56_Login_And_Verify_MainDevicesPage_Workflow deviceLocationPage(Consumer<DeviceLocationPage> c){
   ...
   //Access resource on device media-contacts
    public TC56_Login_And_Verify_MainDevicesPage_Workflow accessResourcesOnDevicePage(Consumer<AccessResourcesOnDevicePage> c){
    ...
    public TC56_Login_And_Verify_MainDevicesPage_Workflow selectYourDevicePage(Consumer<SelectYourDevicePage> c){
    ...
    public TC56_Login_And_Verify_MainDevicesPage_Workflow selectYourDevicePage2(Consumer<SelectYourDevicePage2> c){
    ...
    public TC56_Login_And_Verify_MainDevicesPage_Workflow welcomeSigninPage(Consumer<SiginPage> c){
    ...
    //Get OTP from email 
    public TC56_Login_And_Verify_MainDevicesPage_Workflow getOTPCode(Consumer<ValidOTP> c){
  ...
  //enter OTP
    public TC56_Login_And_Verify_MainDevicesPage_Workflow enterOTPPage(Consumer<EnterValidOTPPage> c){
    ...
    //OTP verified
    public TC56_Login_And_Verify_MainDevicesPage_Workflow codeVerifiedPage(Consumer<CodeVerifiedPage> c){
    ...
    public TC56_Login_And_Verify_MainDevicesPage_Workflow somethingWentWrongPage(Consumer<ErrorCode_0015_1805_Something_Went_Wrong_Page> c){
    ...
    public TC56_Login_And_Verify_MainDevicesPage_Workflow setupWifi(Consumer<SetUpYourWiFiManagementPage> c){
    ...
    //Home Page
    public TC56_Login_And_Verify_MainDevicesPage_Workflow homePage(Consumer<HomePage> c){
    	HomePage p = new HomePage();
        c.accept(p);
        return this;
    }
    
    public TC56_Login_And_Verify_MainDevicesPage_Workflow mainDevicePage(Consumer<MainDeviceAllTabPage> c){
    	MainDeviceAllTabPage p = new MainDeviceAllTabPage();
        c.accept(p);
        return this;
    }
