...
//		new SpeedTestPage().getAppRatingDialogObject().clickThreeStar();
//		new SpeedTestPage().getAppRatingDialogObject().enterFeedback();
//		new SpeedTestPage().getAppRatingDialogObject().clickSendFeebackButton();
//	}
//}