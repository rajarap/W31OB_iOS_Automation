...
public class TC60_Login_And_Verify_HamburgerMenuPage_Test extends ParentClass
{
	...
	int totalCountOfDevices;
	 ...
	 public void beforeClass() throws Exception 
	 {
	  ...
	  {
		  TC60_Login_And_Verify_HamburgerManuPage_Workflow.getStartedPage(getStarted -> {
