...
//			softwhoshome1.assertTrue(new HomePage().getWhoseHomePageObject().clickAddMemeberButton());
			if(new HomePage().getWhoseHomePageObject().getHomeMonitoringPageObject().isAt()) 
				softwhoshome1.assertTrue(new HomePage().getWhoseHomePageObject().getHomeMonitoringPageObject().enableMonitoring());
...
//	  }
	  ...
	  @Test(priority = 62, dependsOnMethods = { "Login_And_Onboard"})
		public void Verify_Whos_Home_Monitoring_Page_Add_Notification() {
	  ...
	  @Test(priority = 63, dependsOnMethods = { "Login_And_Onboard"})
		public void Verify_Whos_Home_Monitoring_Page_Verify_Notification() {
			SoftAssert softwhoshome11 = new SoftAssert();
			
			if(new HomePage().getWhoseHomePageObject().getHomeMonitoringPageObject().getNotifyMeWhenPageObject().isAt())
				softwhoshome11.assertTrue(new HomePage().getWhoseHomePageObject().getHomeMonitoringPageObject().getNotifyMeWhenPageObject().getAddNewNotificationPageObject().selectMemberOne());
