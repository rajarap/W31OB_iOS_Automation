...
// We did like to help you place your satellite

public class AddSatellitePlacementTipsPage extends ParentClass implements Page {
	...
	public AddSatellitePlacementTipsPage() {
		PageFactory.initElements(new AppiumFieldDecorator(super.getDriver()), this);
	}

	public boolean clickContnueButton() {
