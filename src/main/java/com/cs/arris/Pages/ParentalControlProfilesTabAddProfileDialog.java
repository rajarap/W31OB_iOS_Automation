...
public class ParentalControlProfilesTabAddProfileDialog extends ParentClass implements Page
{
	...
	public ParentalControlProfilesTabAddProfileDialog()
	{
	...
	{
		click(closeIcon);
		utils.log().info("Add Profiles Dialog - Clicked on Close Icon");
	}
	
	public void clickCreateProfileButton()
	{
		click(createProfileButton);
		utils.log().info("Add Profiles Dialog - Clicked on Create Profile Button Icon");
	}
