...
public class NetworkLANSettingsHelpPage extends ParentClass implements Page {
	public TestUtils utils = new TestUtils();

	@AndroidFindBy(id = "com.arris.sbcBeta:id/ivDialogClose")
	public MobileElement closeButton;

	@AndroidFindBy(xpath = "//android.widget.TextView[@text='LAN Networking Settings']") 
	public MobileElement lanSettingstitle;
	

	public NetworkLANSettingsHelpPage() {
...
//	}
	...
	public boolean isAt() {
		if (lanSettingstitle.isDisplayed()) {
			utils.log().info("On LAN Settings Help Page");
			return true;
		} else {
			utils.log().info("Not on LAN Settings Help Page");
			return false;
		}
	}
}
