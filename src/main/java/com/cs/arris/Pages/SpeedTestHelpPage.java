...
public class SpeedTestHelpPage extends ParentClass implements Page {
	public TestUtils utils = new TestUtils();
	
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeButton[@name=\"cross\"]")
	public MobileElement closeButton;

	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"SpeedTest\"]")
	public MobileElement speedTestTitle;
	

	public SpeedTestHelpPage() {
...
//	}
	...
	public boolean isAt() {
		if (speedTestTitle.isDisplayed()) {
			utils.log().info("On Speed Test Help Page");
			return true;
		} else {
			utils.log().info("Not on Speed Test Help Page");
			return false;
		}
	}
}
