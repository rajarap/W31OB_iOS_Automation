...
public class NetworkDevicePrioritySettingsHelpPage extends ParentClass implements Page {
	public TestUtils utils = new TestUtils();

	@iOSXCUITFindBy(xpath="//XCUIElementTypeButton[@name=\"cross\"]")
	public MobileElement closeButton;

	@iOSXCUITFindBy(xpath="//XCUIElementTypeStaticText[@name=\"Networking Device Priority Settings\"]") 
	public MobileElement devicePrioritySettingstitle;
	

	public NetworkDevicePrioritySettingsHelpPage() {
...
//	}
	...
	@Override
	public boolean isAt() {
		if (devicePrioritySettingstitle.isDisplayed()) {
			utils.log().info("On Device Priority Settings Help Page");
			return true;
		} else {
			utils.log().info("Not on Device Priority Settings Help Page");
			return false;
		}
	}
}
